    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-card to-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-xl shadow-lg p-8">
          ...
          <p className="text-muted-foreground mb-8">Accede a tu cuenta de PartsHub</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {submitted && (
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-green-500">¡Sesión iniciada!</p>
                  <p className="text-sm text-green-500/80">Serás redirigido en un momento...</p>
                </div>
              </div>
            )}
          </form>
